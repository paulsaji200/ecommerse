...
import { addAddressAsync } from '../../redux/user/address';
...
const AddressForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
      ...
      <p className="text-sm text-gray-600 mb-4">Fill in the below details to add a new address</p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <label htmlFor="city" className="block text-sm font-medium text-gray-700">City / District / Town</label>
            <input
              type="text"
              id="city"
              value={formData.city}
        ...
        <div className="mb-6">
          <label htmlFor="alternate" className="block text-sm font-medium text-gray-700">Alternate Number</label>
          <input
            type="tel"
            id="alternate"
